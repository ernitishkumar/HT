	...
	protected void processRequest(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		try{
			...
			if(user!=null){
				...
				if(action!=null && action.toLowerCase().equals("generate")){
				...
				}else if(action!=null && action.toLowerCase().equals("fetch_bill")){
					System.out.print("Got action in BillingController as : "+action);
					String billDetailsId = (String)httpServletRequest.getParameter("billDetailsId");
					boolean billFound = false;
					BillDetailsView billDetailsView = null;
					JsonElement element = null;
					if(billDetailsId != null){
						BillDetails billDetails = billDetailsDAO.getById(Integer.parseInt(billDetailsId.trim()));
